...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        //PartitaDiCalcio partitaDiCalcio2 = new PartitaDiCalcio("Coppa del mondo marcio", LocalDate.of(2024, 5, 18), "almeno 3 gambe rotte", TipoEvento.PUBBLICO, 1000, loc1FromDB, "Milan", "Inter", "Inter", 2, 4);
        //eddy.save(partitaDiCalcio2);
        GaraDiAtletica primaGara = new GaraDiAtletica("Nuoto stile libero", LocalDate.of(2024, 8, 23), "Diego senza mani", TipoEvento.PRIVATO, 2, location2, arianna);
        eddy.save(primaGara);

        Concerto concertoFabriFibra = new Concerto("Fabri Fibra è Tanta roba", LocalDate.of(2024, 8, 20), "Comandare è meglio che sc..", TipoEvento.PUBBLICO, 500, location2, GenereConcerto.POP, false);
        eddy.save(concertoFabriFibra);
